...
const Footer = () => {
  ...
  return (
    <footer id="connect" className="bg-primary">
        ...
        >
          <div className="flex items-center justify-between mb-5">
            ...
            <div className="flex items-center gap-4">
              <button onClick={toggleTheme} className="w-8 h-8 border border-divider/10 hover:border-accentHover/40 flex items-center justify-center text-secondaryText/50 hover:text-primaryText transition-all duration-300" aria-label="Toggle Theme">
                {theme === 'dark' ? (
